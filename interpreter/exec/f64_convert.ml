...
let convert_i32_s x =
  F64.of_float (Int32.to_float (I32.to_bits x))
 ...
 *)
let convert_i32_u x =
  F64.of_float Int64.(to_float (logand (of_int32 (I32.to_bits x)) 0x00000000ffffffffL))

let convert_i64_s x =
  F64.of_float (Int64.to_float (I64.to_bits x))
...
let reinterpret_i64 x = F64.of_bits (I64.to_bits x)
